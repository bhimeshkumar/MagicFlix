...
public class CircularSeekBar extends View {
	...
	private void initAttributes(TypedArray a) {
		mColorWheelStrokeWidth = a.getInteger(
				R.styleable.CircularSeekBar_wheel_size, 16);
		mPointerRadius = a.getInteger(
				R.styleable.CircularSeekBar_pointer_size, 48);
		max = a.getInteger(R.styleable.CircularSeekBar_max, 100);

		wheel_color_attr = a
				.getString(R.styleable.CircularSeekBar_wheel_active_color);
		wheel_unactive_color_attr = a
				.getString(R.styleable.CircularSeekBar_wheel_unactive_color);
		pointer_color_attr = a
				.getString(R.styleable.CircularSeekBar_pointer_color);
		pointer_halo_color_attr = a
				.getString(R.styleable.CircularSeekBar_pointer_halo_color);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			conversion = Integer.parseInt(text);
			if (mOnCircleSeekBarChangeListener != null) {
