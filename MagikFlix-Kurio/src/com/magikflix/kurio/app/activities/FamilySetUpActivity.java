...
public class FamilySetUpActivity extends BaseActivity implements OnClickListener, OnEditorActionListener {
	...
	private String getDefaultProfilePath(){
		...
		if(!blueAdded){
			return defaultProfilePath =  "android.resource://com.magikflix.kurio/" + R.drawable.avatar_blue;
		}
		if(!greenAdded){
			return defaultProfilePath =  "android.resource://com.magikflix.kurio/" + R.drawable.avatar_green;
		}
		if(!kidAdded){
			return defaultProfilePath =  "android.resource://com.magikflix.kurio/" + R.drawable.avatar_kid;
		}
		if(!pinkAdded){
			return defaultProfilePath =  "android.resource://com.magikflix.kurio/" + R.drawable.avatar_pink;
		}
		if(!purpleAdded){
			return defaultProfilePath =  "android.resource://com.magikflix.kurio/" + R.drawable.avatar_purple;
		}
	...
	private int getDefaultAvatarIndex(UserProfile userProfile) {
		...
		userProfile.deaultAvatar =  "android.resource://com.magikflix.kurio/" + R.drawable.avatar_kid;
	...
	private void addedDeaultAvatars(){
		...
		for (UserProfile userProfile : mDb4oProvider.getUserProfiles()) {
			if(userProfile.deaultAvatar.equalsIgnoreCase("android.resource://com.magikflix.kurio/" + R.drawable.avatar_blue)){
				blueAdded = true;
			}if(userProfile.deaultAvatar.equalsIgnoreCase("android.resource://com.magikflix.kurio/" + R.drawable.avatar_green)){
				greenAdded = true;
			}
			if(userProfile.deaultAvatar.equalsIgnoreCase("android.resource://com.magikflix.kurio/" + R.drawable.avatar_kid)){
				kidAdded = true;
			}
			if(userProfile.deaultAvatar.equalsIgnoreCase("android.resource://com.magikflix.kurio/" + R.drawable.avatar_pink)){
				pinkAdded = true;
			}
			if(userProfile.deaultAvatar.equalsIgnoreCase("android.resource://com.magikflix.kurio/" + R.drawable.avatar_purple)){
				purpleAdded = true;
			}
