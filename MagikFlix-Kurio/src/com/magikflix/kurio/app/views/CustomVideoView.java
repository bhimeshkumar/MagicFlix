...
import com.magikflix.kurio.medialplayer.MediaPlayerInternals;
import com.magikflix.kurio.medialplayer.PlayerControlInterface;
 ...
 */
public class CustomVideoView extends SurfaceView implements PlayerControlInterface {
	...
	private MediaControllerEventListener controllerListener;
	public interface MediaControllerEventListener{
		public void controllerHiden();
		public void controllerVisible();
	}
	
	public void setMediaContrllerListener(MediaControllerEventListener listen){
...
//    }
    ...
    private void toggleMediaControlsVisiblity() {
        if (mMediaController.isShowing()) {
            mMediaController.hide();
            controllerListener.controllerHiden();
        } else {
            mMediaController.show();
            controllerListener.controllerVisible();
        }
    }
   ...
   // cache duration as mDuration for faster access
	...
	@Override
	public void setFullscreen(boolean fullscreen, Context context) {
